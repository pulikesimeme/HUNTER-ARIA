...
from bot import bot, Interval, OWNER_ID, INDEX_URL, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, \
                 BLOCK_MEGA_FOLDER, BLOCK_MEGA_LINKS, VIEW_LINK, aria2, \
...
class MirrorListener:
    def __init__(self, bot, update, isZip=False, extract=False, isLeech=False, pswd=None, tag=None):
        self.bot = bot
        self.update = update
...
def _mirror(bot, update, isZip=False, extract=False, isLeech=False, pswd=None):
    ...
    if reply_to is not None:
        ...
        if (
            ...
            if file is None:
                ...
                listener = MirrorListener(bot, update, isZip, extract, isLeech, pswd, tag)
